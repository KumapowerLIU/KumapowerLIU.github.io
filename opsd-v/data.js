export const project = {
  ...
  authors: [
    ...
    { name: "Feng Gao", affiliations: [2], notes: ["*"], url: "https://scholar.google.com/citations?user=lFkCeoYAAAAJ&hl=en" },
    { name: "Xuanhua He", affiliations: [1, 2], url: "https://xuanhuahe.github.io/" },
    { name: "Yue Ma", affiliations: [1], url: "https://mayuelala.github.io/" },
    { name: "Ziyu Wan", affiliations: [3], url: "http://raywzy.com/" },
    { name: "Yong Zhang", affiliations: [2], notes: ["†"], url: "https://auto202603.github.io/" },
    { name: "Xiaoming Wei", affiliations: [2], url: "https://scholar.google.com/citations?user=JXV5yrZxj5MC&hl=zh-CN" },
    { name: "Qifeng Chen", affiliations: [1], notes: ["*"], url: "https://cqf.io/" },
  ],
  affiliations: [
    { id: 1, name: "HKUST" },
    { id: 2, name: "Meituan" },
